...
module Api
  module V1
    class ActivitiesController < ApplicationController
      ...
      before_action :set_activity, only: %i[show update destroy finish]
      ...
      api :POST, '/api/v1/training_sessions/:training_session_id/activities',
          'Creates a new activity'
      param :training_session_id, Integer,
            desc: 'id of the training session which will own the activity', required: true
      ...
      param :id, Integer, desc: 'id of the requested activity', required: true
      param :complete, [true, false], desc: 'Options to terminate or not an activity',
                                      required: true
      def finish

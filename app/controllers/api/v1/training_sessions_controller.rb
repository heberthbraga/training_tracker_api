...
module Api
  module V1
    class TrainingSessionsController < ApplicationController
      before_action :set_training_session, only: %i[show update destroy activities]
      ...
      api :DELETE, '/api/v1/training_sessions/:id/activities',
          'List all open activities of a training'
      param :id, Integer, desc: 'id of the requested training', required: true
      def activities
